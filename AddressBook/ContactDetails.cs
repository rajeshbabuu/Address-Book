...
namespace AddressBook
{
    ...
    {
        Dictionary<long, Person> contactDetails = new Dictionary<long, Person>();

        public void AddContactDetails(Person contactDetail) //using mobile number because it is unique.
        {
